...
const PasswordResetToken = () => {
  ...
  const PasswordResetUrl = process.env.REACT_APP_EMPLOYER_RESET_PASSWORD
  ...
  const handlePasswordReset = async (formData) => {
    const url = `${baseUrl}${PasswordResetUrl}`;
    try {
  ...
  return (
    ...
    {failuerMessage && (
     ...
     <PasswordResetTokenForm loginPath="/employer/login" onPasswordReset={handlePasswordReset} />
    </>
  );
};
